...
public:
    ...
    inline void SetRotationScaler(float fRotationScaler = DirectX::XM_PI) { m_fRotationScaler = fRotationScaler; }
    inline void SetMoveScaler(float fMoveScaler = 5.0F) { m_fMoveScaler = fMoveScaler; }
    ...
    inline float GetRotationScaler() const { return m_fRotationScaler; }
    inline float GetMoveScaler() const { return m_fMoveScaler; }
